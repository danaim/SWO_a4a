...
**Authors:** E. Jardim^1^, C. Millar^2^, D. Mantopoulou-Palouka^3^, I. Mosqueira^4^
...
^1^Instituto Português do Mar e Atmosfera (IPMA), Lisbon, Portugal / DTU-Aqua, Copenhagen, Denmark. ernesto.jardim@gmail.com  
^2^International Council for the Exploration of the Sea (ICES), Copenhagen, Denmark.  
^3^European Commission Joint Research Centre (JRC), Ispra, Italy.  
^4^Wageningen Marine Research (WMR), IJmuiden, The Netherlands.
...
The a4a framework implements a statistical catch-at-age (SCA) model. The core population dynamics follow standard age-structured equations:
...
- **ICCAT context**: The framework is directly applicable to ICCAT tuna, shark, and billfish stocks that have age-structured data available, and has methodological overlap with models already used within ICCAT working groups.
...
*Developed by Jardim, Millar, Mantopoulou-Palouka, Mosqueira, and collaborators*
...
- **CRAN/FLR install**: `install.packages(c("FLCore","FLa4a","FLBRP","FLasher","a4adiags","ggplotFL"), repos=c(FLR="https://flr.r-universe.dev", CRAN="https://cloud.r-project.org"))`
...
### a4a Handbook and Documentation

*Handbook by Jardim, Millar, Mantopoulou-Palouka, and Mosqueira (2026)*

The book *Age-structured stock assessment modeling with R: The a4a Initiative* provides a comprehensive overview of the a4a framework from its conceptual basis and technical implementation to operational use. Each chapter functions as a self-contained vignette for the FLa4a package.

- **Online book (Bookdown)**: https://flr-project.org/a4a-book (check for latest version)
- **License**: Creative Commons CC BY-SA 4.0; FLa4a package released under EUPL 1.1
...
Cadrin, S.X. 2025. Stock assessment diagnostics. *In*: Age-structured stock assessment modeling with R: The a4a Initiative. Jardim et al.
...
Jardim, E., Millar, C.P., Mosqueira, I., Scott, F., Osio, G.C., Ferretti, M., Alzorriz, N., and Eero, M. 2014. What if stock assessment is as simple as a harvest control rule? Simulation testing FLa4a, a simplified stock assessment method. *ICES Journal of Marine Science*, 72(1): 232–245.

Jardim, E., Millar, C., Mantopoulou-Palouka, D., and Mosqueira, I. 2026. *Age-structured stock assessment modeling with R: The a4a Initiative*. March 2026.
...
Robertson, M.D., Regular, P.M., and Cadigan, N.G. 2022. Aligning fisheries assessments with ecosystem model complexity. *Fish and Fisheries*, 23(3): 688–699.
